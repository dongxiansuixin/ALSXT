...
#include "ALSXTAbilityTaskPlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class ALSXT_API UALSXTAbilityTaskPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	UALSXTAbilityTaskPlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UALSXTAbilityTaskPlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
